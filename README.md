...
- Terminus (links in [terminus directory](../linux_cyber_unit/terminus))
...
## Terminus 
In the terminus directory is a file [terminus.md](../linux_cyber_unit/terminus/terminus.md) that has additional information.
